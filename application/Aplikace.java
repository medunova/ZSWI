...
public class Aplikace  extends Application{
	...
	public void start(Stage primaryStage){
		try{
			sc = new Scanner(new File("kategorie.txt"));									//načtení kategorií
			...
			sc = new Scanner(new File("otazky.txt"));										//načtení otázek
			...
			alert.setHeaderText("Chyba při psuštění programu!");
